...
Or, you can also install manually with poetry:
...
This method is for entering product and buyer information.<br>
...
This method is for approving payment.<br>
...
This method is for cancel payment<br>
...
### order ###
This method is for getting payment information<br>
...
You can service single payment with `RecurringPayment` class.
It has `ready`, `approval`, `subscription`, `inactive`, `status` methods
...
This method is for recurring payments.<br>
`subscription` method take these arguments:
- sid: str, id for recurring payment 
- partner_order_id: str, order id for payment
- partner_user_id: str, user id who need to pay
- quantity: int
- total_amount: int, total amount to be paid
...
This method is for inactiving recurring payments.<br>
`inactive` method take these arguments:
- sid: str, id for recurring payment 
...
This method is for getting recurring payment information. <br>
`status` method take these arguments:
- sid: str, id for recurring payment 
